...
All M1–M13 milestones of the 2026-04-16 security & DX refactor are shipped on the `v0.7.0-security` branch, one commit per milestone.

Remaining before squash-merge:
