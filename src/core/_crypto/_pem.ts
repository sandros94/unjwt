...
const getElement = (seq: Uint8Array<ArrayBuffer>) => {
  const result = [];
  let next = 0;
...
const parseElement = (bytes: Uint8Array<ArrayBuffer>) => {
  let position = 0;
