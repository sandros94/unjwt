...
import type { JWEKeyManagementHeaderParameters, JWEHeaderParameters, JWK, JWK_EC } from '../types'
import { base64UrlEncode, base64UrlDecode, isJWK, assertCryptoKey, isCryptoKey } from '../utils'
...
export async function encryptKey(
  ...
  switch (alg) {
    ...
    case 'ECDH-ES+A256KW': {
      ...
      const ephemeralKey: CryptoKey = providedParameters.epk ? (await normalizeKey(providedParameters.epk, alg)) as CryptoKey : (
